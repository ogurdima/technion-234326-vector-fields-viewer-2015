...
PolyMeshViewer::PolyMeshViewer(const char* _title, int _width, int _height) : GlutExaminer(_title, _width, _height)
{
...
bool PolyMeshViewer::open_mesh(const char* _filename)
{
	// load mesh
...
void PolyMeshViewer::update_face_indices()
{
...
void PolyMeshViewer::draw(const std::string& _draw_mode)
{
	if (indices_.empty())
	{
